...
import com.stencil.merchant.dto.BucketPolicyConfigDto;
import com.stencil.merchant.dto.MinioUploadDto;
import io.minio.*;
...
public class MinioController {
    ...
    public CommonResult upload(@RequestParam("file") MultipartFile file) {
        try {
            ...
            // 设置存储对象名称
            String objectName = "merchant" + "/" + IdUtil.simpleUUID() + "/" + filename;
